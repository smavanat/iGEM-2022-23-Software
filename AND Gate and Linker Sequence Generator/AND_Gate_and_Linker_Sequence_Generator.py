...
#Combines two lists together into one array so that their constituent variables appear in an alternating sequence
...
def toeholdSwitchGen(numMiRNA):
    ...
    if(numMiRNA !=1):
        ...
        listAddition(unpairedMiddleArray, toeholdAndGates)
